...
- Before adding a new service, class, file, interface, or abstraction, check whether an existing owner/module is the correct home.
...
- Do not reimplement another chip protocol manually if an existing hardened project library already provides the needed timeout, recovery, and testability behavior.
