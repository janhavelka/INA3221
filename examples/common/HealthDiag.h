/**
 * @file HealthDiag.h
 * @brief Verbose health diagnostic helpers for INA3221 examples.
 *
 ...
 */
inline const char* stateToString(INA3221::DriverState state) {
  switch (state) {
    case INA3221::DriverState::UNINIT:   return "UNINIT";
    case INA3221::DriverState::READY:    return "READY";
    case INA3221::DriverState::DEGRADED: return "DEGRADED";
    case INA3221::DriverState::OFFLINE:  return "OFFLINE";
 ...
 */
inline const char* errToString(INA3221::Err err) {
  switch (err) {
    case INA3221::Err::OK:                        return "OK";
    case INA3221::Err::NOT_INITIALIZED:           return "NOT_INITIALIZED";
    case INA3221::Err::INVALID_CONFIG:            return "INVALID_CONFIG";
    case INA3221::Err::I2C_ERROR:                 return "I2C_ERROR";
    case INA3221::Err::TIMEOUT:                   return "TIMEOUT";
    case INA3221::Err::INVALID_PARAM:             return "INVALID_PARAM";
    case INA3221::Err::DEVICE_NOT_FOUND:          return "DEVICE_NOT_FOUND";
    case INA3221::Err::MANUFACTURER_ID_MISMATCH:  return "MANUFACTURER_ID_MISMATCH";
    case INA3221::Err::DIE_ID_MISMATCH:           return "DIE_ID_MISMATCH";
 ...
 */
inline const char* stateColor(INA3221::DriverState state) {
  switch (state) {
    case INA3221::DriverState::READY:    return LOG_COLOR_GREEN;
    case INA3221::DriverState::DEGRADED: return LOG_COLOR_YELLOW;
    case INA3221::DriverState::OFFLINE:  return LOG_COLOR_RED;
    case INA3221::DriverState::UNINIT:   return LOG_COLOR_GRAY;
 ...
 */
inline void printHealthOneLine(INA3221::INA3221& driver) {
  INA3221::DriverState st = driver.state();
 ...
 */
inline void printHealthVerbose(INA3221::INA3221& driver) {
  INA3221::DriverState st = driver.state();
  INA3221::Status lastErr = driver.lastError();
  uint32_t now = millis();
...
struct HealthSnapshot {
  INA3221::DriverState state;
  uint8_t consecutiveFailures;
  uint32_t totalSuccess;
  uint32_t totalFailures;
  uint32_t timestamp;

  void capture(INA3221::INA3221& driver) {
    state = driver.state();
...
public:
  ...
  void begin(uint32_t intervalMs = 1000) {
    ...
    _lastLogMs = 0;
    _lastState = INA3221::DriverState::UNINIT;
    _lastConsecFail = 0;
  }
   ...
   */
  void tick(INA3221::INA3221& driver, bool forceLog = false) {
    uint32_t now = millis();
    INA3221::DriverState currentState = driver.state();
...
private:
  ...
  INA3221::DriverState _lastState = INA3221::DriverState::UNINIT;
